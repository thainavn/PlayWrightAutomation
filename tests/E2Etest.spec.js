...
test('E2E', async ({ browser }) => {
    ...
    const email = "ngoanhthai13@gmail.com";
    ...
    await page.locator("[placeholder='Select Country']").fill("nam");
    await page.locator("[class='user__address'] button").last().click();
    ...
    await page.locator("[class='icon icon-arrow-right-circle']").click();
    ...
    await expect(page.locator("[scope='row']").textContent()).toContainText(orderID);
    await page.locator("[class='btn btn-primary']").click();
    await expect(page.locator("[class='col-text -main']").textContent()).toContainText(orderID);
    await expect(page.locator("[class='text']").nth(0).textContent()).toContainText(email);
    await expect(page.locator("[class='text']").nth(1).textContent()).toContainText("Country - Vietnam");
    await expect(page.locator("[class='text']").nth(2).textContent()).toContainText(email);
    await expect(page.locator("[class='text']").nth(3).textContent()).toContainText("Country - Vietnam");
})